    ...
    case 'search':
      return (
        <svg viewBox="0 0 16 16" {...defaultProps}>
          ...
          <path d="M14 14L10 10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      );
    case 'menu-fold':
      return (
    ...
    case 'edit':
      return (
        <svg viewBox="0 0 16 16" {...defaultProps}>
          ...
          />
          <path
            d="M10.6667 3.33334L12.6667 5.33334"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      return (
        <svg viewBox="0 0 16 16" {...defaultProps}>
          ...
          <path
            ...
            strokeLinejoin="round"
          />
          <path d="M8 10V12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      );
    case 'euro':
      return (
    ...
    case 'alert':
      return (
        <svg viewBox="0 0 49 45" {...defaultProps}>
          ...
          <path fillRule="evenodd" d="M23.689,4.691 L42.683,38.682 L4.696,38.682 L23.689,4.691 L23.689,4.691 Z" />
      ...
      return (
        <svg width="1em" height="1em" viewBox="0 0 16 8">
          <path
            fillRule="evenodd"
            fill="currentColor"
            d="M1.520,4.000 C1.520,2.632 2.632,1.520 4.000,1.520 L7.200,1.520 L7.200,-0.000 L4.000,-0.000 C1.792,-0.000 -0.000,1.792 -0.000,4.000 C-0.000,6.208 1.792,8.000 4.000,8.000 L7.200,8.000 L7.200,6.480 L4.000,6.480 C2.632,6.480 1.520,5.368 1.520,4.000 ZM4.800,4.800 L11.200,4.800 L11.200,3.200 L4.800,3.200 L4.800,4.800 ZM12.000,-0.000 L8.800,-0.000 L8.800,1.520 L12.000,1.520 C13.368,1.520 14.480,2.632 14.480,4.000 C14.480,5.368 13.368,6.480 12.000,6.480 L8.800,6.480 L8.800,8.000 L12.000,8.000 C14.208,8.000 16.000,6.208 16.000,4.000 C16.000,1.792 14.208,-0.000 12.000,-0.000 Z"
          />
        </svg>
      );
  }
